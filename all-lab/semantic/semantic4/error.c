...
struct ErrorMessage errors[32] = {
    ...
    {ERR_CONDITIONAL_EXPRESSION_REQUIRE, " Must use conditional expression here."},
    ...
    {ERR_FLOAT_INDEX_FOR_STATEMENT, "Can't use real number for indexing for statement."},
    {MODUL_OPERATOR_CANNOT_USE_ERROR, "Can't use real number with modulo operator"},
